...
public class InstanceBasedLabelRankingConfiguration extends AAlgorithmConfigurationWithBaseLearner {
	...
	private static final String DEFAULT_CONFIGURATION_FILE_NAME = "learningalgorithm" + StringUtils.FORWARD_SLASH
			+ "labelranking" + StringUtils.FORWARD_SLASH + "instance_based_label_ranking";
	...
	/**
	 * Creates a new configuration for the
	 ...
	 *             if the setting of the parameters failed
	 */
	...
	/**
	 * Validates the base learner algorithm and the rank aggregation learning
	 * algorithm.
	 *
	 * @throws ParameterValidationFailedException
	...
	private void validateLearningAndBaseLearnerAlgorithm() throws ParameterValidationFailedException {
		if (this.rankAggregationAlgorithmDefinition == null
				|| this.rankAggregationAlgorithmDefinition.getName() == null) {
		...
		if (!(baseLearnerAlgorithm instanceof KNearestNeighborClassification)) {
			throw new ParameterValidationFailedException(String.format(ERROR_MESSAGE_BASE_LEARNER_NOT_SUPPORTED,
					EBaseLearner.KNEAREST_NEIGHBOUR.getBaseLearnerIdentifier()));
		}
	}
	...
	/** 
	 * Sets the rank aggregation algorithm.
	 * 
	 * @param rankAggregationAlgorithm the rank aggregation algorithm
	 */
	public void setRankAggregationAlgorithm(ILearningAlgorithm rankAggregationAlgorithm) {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((rankAggregationAlgorithmDefinition == null) ? 0 : rankAggregationAlgorithmDefinition.hashCode());
		return result;
	}
