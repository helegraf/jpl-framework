...
/**
 * Enumeration of all supported base leaner in the tool. If a new algorithm is
 * added it has to be added to this enumeration if it should be available for
 * the configuration of any current {@link ILearningAlgorithm} which is using
 * it. If the algorithm should only be used via the API, there is no need to add
 * it here.
 * 
 * @author Pritha Gupta
 *
...
public enum EBaseLearner {
	 ...
	 */
	LOGISTIC_REGRESSION_WEKA("logistic_regression_WEKA", false, true, false, true) {
		@Override
	...
	/**
	 * {@link Enum} associated with the {@link PerceptronLearningAlgorithm} base
	 * leaner.
	 */
	...
	/**
	 * {@link Enum} associated with the {@link MiniBatchPegasosLearningAlgorithm}
	 * base leaner.
	 */
	...
	/**
	 * {@link Enum} associated with the {@link SupportVectorMachineClassification}
	 * base leaner.
	 */
	...
	/**
	 * {@link Enum} associated with the {@link KNearestNeighborClassification} base
	 * leaner.
	 */
	...
	/**
	 * Creates a {@link EBaseLearner} with the given identifier. Also some flags are
	 * set so that it can be checked later, if the given base learner is applicable
	 * for a specific learning algorithm.
	 * 
	 * @param baseLearnerIdentifier
	 *            the identifier of the base learner, has to be unique
	 * @param isClassifier
	 *            {@code true} if the base learner is a classifier
	 * @param isReturningProbability
	 *            {@code true} if the base learner is returning probabilities
	 * @param isCapableOfHandlingMultipleClasses
	 *            {@code true} if the base learner is able to handle multiple
	 *            classes
	 * @param isCapableOfHandlingInstanceWeights
	 *            {@code true} if the base learner is able to handle instance
	 *            weights
	 */
	 ...
	 * 
	 * @return {@code true} if the base leaner is a classifier, otherwise
	 *         {@code false}
	 */
	 ...
	 * 
	 * @return {@code true} if the base learner is returning probabilities,
	 ...
	 * 
	 * @return {@code true} if the base learner is able to handle multiple classes,
	 *         otherwise {@code false}
	 */
	 ...
	 * 
	 * @return {@code true} if the base learner is able to handle instance weights,
	 *         otherwise {@code false}
	 */
	...
	/**
	 * Returns the according {@code EBaseLearner} instance which has the identifier
	 * to search for.
	 * 
	 * @param baseLearnerIdentifier
	 *            the identifier of the base learner as string to search for
	 * @return the instance of {@link EBaseLearner} with the given
	 *         {@code baseLearnerIdentifier} if found, otherwise {@code null}
	 */
	...
	/**
	 * Returns a list containing all existing {@link EBaseLearner}, which are
	 * classifiers.
	 * 
	...
	/**
	 * Returns a list containing all existing {@link EBaseLearner}, which are able
	...
	/**
	 * Create a new instance of the base learner implementation which is linked to
	 * this enumeration.
	 * 
	 * @return a new instance of the base learner which is linked to this
	 *         enumeration
	 */
